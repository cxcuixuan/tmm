function y=redcross(a,b)
 ...
 S11_g = S11_g+S12_g/((eye(la/2)-S11_d*S22_g))*S11_d*S21_g;
 S12_g = S12_g/((eye(la/2)-S11_d*S22_g))*S12_d;
 S21_g = S21_d/((eye(la/2)-S22_g*S11_d))*S21_g;
 S22_g = S22_d+S21_d/((eye(la/2)-S22_g*S11_d))*S22_g*S12_d;
